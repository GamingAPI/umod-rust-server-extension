...
namespace Oxide.Ext.Blackhawk
{
    ...
    using System.Timers;
    public class BlackhawkNats : Asyncapi.Nats.Client.NatsClient
    {
        private static BlackhawkNats instance = null;
        ...
        private BlackhawkNats(Asyncapi.Nats.Client.LoggingInterface logger)
        {
            this.Logger = logger;
        ...
        private BlackhawkNats() : this(new Imp())
        {
        }
        ...
        public static BlackhawkNats SetInstance()
        {
            try
            {
        ...
        public static BlackhawkNats SetInstance(Asyncapi.Nats.Client.LoggingInterface logger)
        {
            try
            {
                rwl.AcquireWriterLock(timeOut);
                try
                {
                    instance = new BlackhawkNats(logger);
                    return instance;
                }
                finally
                {
        ...
        public static BlackhawkNats GetInstance()
        {
            try
            {

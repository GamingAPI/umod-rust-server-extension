...
namespace Oxide.Ext.Blackhawk
{
    ...
    public class DefaultPluginInformation
    {
        ...
        public BlackhawkNats NatsClient { get; }

        private class Logger : Asyncapi.Nats.Client.LoggingInterface
        {
            public void Debug(string m)
            {
                Interface.Oxide.LogDebug("[Blackhawk DefaultPluginInformation]" + m);
            }

            public void Error(string m)
            {
                Interface.Oxide.LogError("[Blackhawk DefaultPluginInformation]" + m);
            }

            public void Info(string m)
            {
                Interface.Oxide.LogInfo("[Blackhawk DefaultPluginInformation]" + m);
            }
        }
        ...
        private DefaultPluginInformation()
        {
            ...
            this.NatsClient = BlackhawkNats.SetInstance(new Logger());
        }

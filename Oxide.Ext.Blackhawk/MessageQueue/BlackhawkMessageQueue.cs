...
namespace Oxide.Ext.Blackhawk.MessageQueue
{
    public sealed class BlackhawkMessageQueue
    {
        ...
        {
            Console.WriteLine("BlackhawkMessageQueue : FLUSHING MESSAGES");
            ...
            flushTimer.Elapsed += new ElapsedEventHandler((object source, ElapsedEventArgs e) =>
            {
                ...
                {
                    flushTimer.Stop();
                    Console.WriteLine("BlackhawkMessageQueue : DONE FLUSHING MESSAGES");
                }
            });
            flushTimer.Start();
        }
        ...
        private bool TryDequeueMessageToCall(MessageImportance importance, Dictionary<MessageImportance, Queue<Action<Action, Action>>> dictionaryToSearch, out Action<Action, Action> action, out MessageImportance messageImportance)
        {
            ...
            {
                Console.WriteLine("BlackhawkMessageQueue : ArgumentNullException: " + e.ToString() + ", loosing message!!!!!!!!!!!!!!!!");
            }
        ...
        private void AddMessageToQueue(Dictionary<MessageImportance, Queue<Action<Action, Action>>> dictionaryToSearch, MessageImportance importance, Action<Action, Action> action)
        {
            ...
            {
                Console.WriteLine("BlackhawkMessageQueue : No queue found for message importance: " + importance.ToString() + ", loosing message!!!!!!!!!!!!!!!!");
            }
        }
        ...
        public static BlackhawkMessageQueue Instance { get { return Nested.instance; } }
        ...
        private class Nested
        {
            ...
            internal static readonly BlackhawkMessageQueue instance = new BlackhawkMessageQueue();
        }
    }
}

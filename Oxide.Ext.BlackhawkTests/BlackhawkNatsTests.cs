...
namespace Oxide.Ext.Blackhawk.Tests
{
    [TestFixture()]
    public class BlackhawkNatsTests
    {
        ...
        BlackhawkNats blackhawkNats;
        BlackhawkTestNats blackhawkTestNats;
        AutoResetEvent stopWaitHandle = new AutoResetEvent(false);
        [SetUp()]
        public void setup()
        {
            Trace.Listeners.Add(new TextWriterTraceListener(Console.Out));
            blackhawkNats = BlackhawkNats.GetInstance();
            Trace.AutoFlush = true;
            Trace.Indent();
            blackhawkTestNats = BlackhawkTestNats.getInstance();

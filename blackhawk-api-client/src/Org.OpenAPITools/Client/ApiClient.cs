...
namespace Org.OpenAPITools.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("https://virtserver.swaggerhub.com/jonaslagoni/RustServer/1.0.0");
        }
        ...
        public ApiClient(String basePath = "https://virtserver.swaggerhub.com/jonaslagoni/RustServer/1.0.0")
        {
        ...
        public void CallApiWithCallback(
            String path, RestSharp.Method method, List<KeyValuePair<String, String>> queryParams, Object postBody,
            Dictionary<String, String> headerParams, Dictionary<String, String> formParams,
            Dictionary<String, FileParameter> fileParams, Dictionary<String, String> pathParams,
            String contentType, Action<IRestResponse, RestRequestAsyncHandle> callback)
        {
